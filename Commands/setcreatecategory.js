    ...
    async execute(interaction) {
        ...
        if (interaction.guild != null) {
            const setEmbed = new EmbedBuilder()
                .setColor('#ef6459')
                .setTitle(`Successfully set ${interaction.options.getChannel('category').name} to the create category.`)
            ...
            if (interaction.member.permissions.has('ADMINISTRATOR')) {
                ...
                if (interaction.options.getChannel('category').type == ChannelType.GuildCategory) {
